...
def run_generator(generator, scaffold_mol, seed, returnMol = False) -> str :
    set_seed(seed)
    generated_mol = generator.generate(scaffold_mol)
    if generated_mol is not None and not returnMol :
...
def main() : 
    ...
    for scaf_idx, scaffold_smi in enumerate(scaffold_list) :
        ...
        for i in range(args.num_samples) :
            ...
            generated_smiles = run_generator(generator, scaffold_mol, seed)
